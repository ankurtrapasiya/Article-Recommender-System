...
public class FavouritesDAOImpl implements FavouritesDAO {
    ...
    @Override
    public List<Favourites> getAllFavourites(Integer userId) throws SQLException {
        List<Favourites> retval = new ArrayList<Favourites>();
        ResultSet rs = null;
        ...
        try {
            ...
            if (con.connect()) {
                ...
                String sql = "select * from favourites where userid=" + userId + " and isfav=" + true;
                rs = con.customQuery(sql);
                
                while (rs.next()) {
                    Favourites fav = new Favourites();
                    
                    fav.setArticleid(rs.getInt("articleid"));
