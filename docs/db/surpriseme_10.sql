...
--
-- Host: localhost
-- Generation Time: Nov 07, 2012 at 11:36 PM
...
-- Database: `surpriseme`
--
CREATE DATABASE `surpriseme` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `surpriseme`;
...
--
-- Creation: Nov 05, 2012 at 09:35 PM
--
...
(3, 'Computer programming', 'Computer programming (often shortened to programming or coding) is the process of designing, writing, testing, debugging, and maintaining the source code of computer programs. This source code is written in one or more programming languages (such as Java, C++, C#, Python, etc.). The purpose of programming is to create a set of instructions that computers use to perform specific operations or to exhibit desired behaviors. The process of writing source code often requires expertise in many different subjects, including knowledge of the application domain, specialized algorithms and formal logic.', 0, 1, 0, '2012-10-03 00:00:00', NULL, '2012-11-07 17:24:55'),
...
(6, 'programming1', 'programming1', 0, 3, 0, '2012-11-01 09:14:14', 0, '2012-11-07 17:24:16'),
(7, 'programming2', 'programming2', 3, 0, 0, '2012-11-01 09:14:59', 0, '2012-11-07 17:24:24'),
(8, 'programming3', 'programming3', 3, 0, 0, '2012-11-01 09:16:06', 0, '2012-11-07 17:24:21'),
(9, 'programming4', 'programming4', 3, 1, 0, '2012-11-01 09:16:24', 0, '2012-11-07 17:27:07'),
...
--
-- RELATIONS FOR TABLE `articleinterest`:
--   `articleid`
--       `article` -> `articleid`
--   `interestid`
--       `interest` -> `interestid`
...
--
-- RELATIONS FOR TABLE `articlelinks`:
--   `articleid`
--       `article` -> `articleid`
--   `sourceid`
--       `source` -> `sourceid`
...
--
-- RELATIONS FOR TABLE `articletag`:
--   `articleid`
--       `article` -> `articleid`
--   `tagid`
--       `tag` -> `tagid`
...
--
-- RELATIONS FOR TABLE `blockedusers`:
--   `blockerid`
--       `user` -> `userid`
--   `userid`
--       `user` -> `userid`
...
--
-- RELATIONS FOR TABLE `favourites`:
--   `userid`
--       `user` -> `userid`
--   `articleid`
--       `article` -> `articleid`
...
--
-- RELATIONS FOR TABLE `interestsources`:
--   `interestid`
--       `interest` -> `interestid`
--   `sourceid`
--       `source` -> `sourceid`
...
--
-- RELATIONS FOR TABLE `taginterest`:
--   `tagid`
--       `tag` -> `tagid`
--   `interestid`
--       `interest` -> `interestid`
...
(1, 'ankur.trapasiya', '0cc175b9c0f1b6a831c399e269772661', 'ankur.trapasiya', 'Ankur', 'Trapasiya', '2012-10-31', NULL, NULL, 'India', 1, '2012-10-31 23:21:02', NULL),
(2, 'anil.trapasiya', 'f2490ad5cb408a98900fd44c28aefc62', 'anil.trapasiya@gmail', 'Anil', 'Trapasiya', '2012-10-31', NULL, NULL, 'India', 1, '2012-10-31 23:21:02', NULL),
(4, 'sonu.trapasiya', '371ab955fdc11c44c980779c3135b155', 'sonu.trapasiya@gmail', 'Sonu', 'Trapasiya', '2012-11-04', NULL, NULL, 'India', 1, '2012-11-04 16:47:25', NULL),
(8, 'at', '81dc9bdb52d04dc20036dbd8313ed055', 'ankur.trapasiya1', 'A', 'a', '2012-11-01', NULL, NULL, 'India', 1, '2012-11-05 00:00:00', NULL),
(9, 'ay1', '81dc9bdb52d04dc20036dbd8313ed055', 'ankur.trapasiya@gmail.com', 'a', 'a', '2012-11-08', NULL, NULL, 'India', 1, '2012-11-05 00:00:00', NULL);
...
--
-- RELATIONS FOR TABLE `useractivation`:
--   `userid`
--       `user` -> `userid`
--
...
--
-- RELATIONS FOR TABLE `userhistory`:
--   `userid`
--       `user` -> `userid`
--   `articleid`
--       `article` -> `articleid`
...
(1, 3, '2012-11-07 22:54:28', 0, 1),
(1, 6, '2012-11-07 22:53:24', 0, 1),
(1, 7, '2012-11-07 22:54:24', 1, 0),
(1, 8, '2012-11-07 22:53:39', 1, 0),
(1, 9, '2012-11-07 22:56:53', 0, 1);
...
--
-- RELATIONS FOR TABLE `userinterest`:
--   `interestid`
--       `interest` -> `interestid`
--   `userid`
--       `user` -> `userid`
...
--
-- RELATIONS FOR TABLE `usersuggestions`:
--   `userid`
--       `user` -> `userid`
--   `friendid`
--       `usergraph` -> `friendid`
