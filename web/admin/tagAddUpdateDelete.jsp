                    ...
                    <tbody> 
                        <c:forEach var="tg" items="${requestScope.data}">
                            ...
                            <tr> 
                                ...
                                <td><a href="InsertImage?name=<c:out value="${tg.icon}"/>&table=tag&column=icon&path=file-upload&file=tagAddUpdateDeleteServlet&key=tagid&value=<c:out value="${tg.tagid}"/>">
