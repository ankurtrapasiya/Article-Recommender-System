<%-- EDITINTEREST
    Document   : ThirdJspForm
    Created on : Oct 30, 2012, 8:10:36 PM
    Author     : Priyank
--%>
    ...
    <body>
        ...
        <section id="main" class="column" >
            <article class="module width_full">
                <header><center><h3>Insert Interest</h3></center></header>
                <div class="module_content">
                    <form action="InterestEdit" method="post">
                  
                        
               Name:           <input type="text" name="txtname" value="<c:out value="${XYZ.name}"/>"><br>
               Description:           <input type="text" name="txtdescription" value="<c:out value="${XYZ.description}"/>"><br>
                 <input type="hidden" value="<c:out value="${name}"/>" name="Icon" /> <br><br>
            
                 
        
         <input type="hidden" name="interestid" value="<c:out value="${XYZ.interestid}"/>">
